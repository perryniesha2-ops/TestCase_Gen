...
// ─── MobileNav — rendered inside AppLayout's mobile header bar ────────────────
              ...
              {[...navigation, ...secondaryNavigation].map((item) => {
                ...
                return (
                  <Button
                    ...
                    onClick={() =>
                      handleNavClick(item.href, () => setIsMobileOpen(false))
                    }
                  >
                    <Icon className="h-4 w-4 shrink-0" />
...
// ─── AppLayout ────────────────────────────────────────────────────────────────
//
// Mobile: stacked layout — top bar (menu + page title slot) above scrollable content.
