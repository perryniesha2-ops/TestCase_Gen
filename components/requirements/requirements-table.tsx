...
interface RequirementsTableProps {
  ...
  totalCount: number;
  itemsPerPage: number;
  onRowClick: (requirement: Requirement) => void; // View details
  onOpenLinkDialog: (requirement: Requirement) => void; // Link tests
  onOpenEditDialog: (requirement: Requirement) => void; // Edit
  onDelete: (requirement: Requirement) => void; // Delete
  ...
  return (
      <div className="space-y-4">
        ...
        <RequirementActionsSheet
            ...
            onView={(r) => onRowClick(r)}
            onLinkTests={(r) => onOpenLinkDialog(r)}
            onEdit={(r) => onOpenEditDialog(r)}
