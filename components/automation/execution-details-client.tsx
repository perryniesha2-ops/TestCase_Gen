          ...
          <div className="flex items-center gap-2">
            ...
            <div>
              ...
              <p className="text-muted-foreground mt-1">
                ...
                {execution.duration_minutes === 1 ? "minute" : "minutes"}
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">Test cases executed</p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">Tests with errors</p>
          </CardContent>
        </Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">
              ...
              {testResults.length > 0
                ? Math.round(
                    (execution.duration_minutes / testResults.length) * 60,
                  )
                : 0}
              s per test
            </p>
        ...
        <CardContent>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            <div>
              ...
              <p className="font-medium">{execution.browser || "Unknown"}</p>
            </div>
            <div>
            ...
            <div>
              ...
              <p className="font-medium">{execution.os_version || "Unknown"}</p>
            </div>
            <div>
